...
function generateItems(items){
    ...
    items.forEach((item) => {
        ...
        addToCartEl.classList.add("product-add", "h-8", "w-28", "bg-yellow-500", "flex", "items-center", "justify-center", "rounded", "text-md", "cursor-pointer", "hover:bg-yellow-600", "text-white");
